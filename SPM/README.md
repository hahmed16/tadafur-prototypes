...
11. [Calculation Principles](#11-calculation-principles)
...
**VR-21** Any status transition not listed in the allowed map (Section 6.1) is rejected.
...
| Approve strategy status transition          | Per transition table in Section 6.3                                                                   |
